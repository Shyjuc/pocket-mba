    ...
    <section id="about" className="about">
      <div className="container" data-aos="fade-up">
        ...
        <div className="section-title">
          <h2>Why Founder's Kit?</h2>
          <h3>Collection of Essential Startup Management Documents for Quick Decision Making and Effective Delegation.</h3>
        </div>

        <div className="row content">
          <div className="col-lg-6">
            <p>
            Founder's Kit is a powerful reference framework created for startups. It includes collection of Ready-to-use Pitch Deck Templates, business presentations, startup management spreadsheets, reference checklists and marketing creatives. 
            </p>
            <p>
          ...
          <div className="col-lg-6 pt-4 pt-lg-0">
            <ul>
              <li><i className="ri-check-double-line"></i> Delegate management level tasks to your team from Marketing research, telecalling to tracking your sales pipeline.</li>
