...
function Navbar() {
  ...
  return (
    ...
    <div className="container d-flex align-items-center full-width" style={{ justifyContent : 'space-between', width: '100%' }}>
      ...
      <div onClick={handleNav} className='d-block d-lg-none right floated'>
